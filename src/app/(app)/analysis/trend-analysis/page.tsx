...
export default function TrendAnalysisPage() {
  ...
  const exportPayload: ExportPayload = {
    title: "STRATEGOS — Trend Analysis Report",
    subtitle: `Last ${days} days | ${bucket} buckets`,
    ...
    tables: [
      ...
      {
        title: "Confidence Level by Date",
        headers: ["Date", "Avg Confidence %"],
        rows: confidenceByDate.map((d) => [d.date, d.value]),
      },
      {
        title: "Alert Rate by Date",
        headers: ["Date", "Alert Rate %"],
        rows: alertByDate.map((d) => [d.date, d.value]),
      },
      {
        title: "Conflict Escalation Trends",
        headers: ["Conflict", "Direction", "Escalation %", "Confidence", "Last Updated"],
